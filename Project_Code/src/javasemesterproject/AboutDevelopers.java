...
public class AboutDevelopers extends JFrame{
    ...
    public AboutDevelopers() {
        ...
        String[][] rowData = {{"18MMCA011HY", "Shaharukh Khan", "<html>Modules Development<html>"}, 
                               {"18MMCA011HY", "Shaharukh Khan", "<html>Modules Integration<br/> and Code Refinement</html>"}, 
                               {"18MMCA011HY", "Shaharukh Khan", "<html>Database Connectity<br/> and Design</html>"}};
