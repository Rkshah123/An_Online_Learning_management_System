...
1. Clone this repo using 
   - `git clone https://github.com/Rkshah123/An-Online-Learning-Management-System`
...
# INTRODUCTION: <br>
**An Online Learning  Management System**  is windows based application developed in java, and using MySQL database.
it targets serving teachers and students in online based learning. where admin can add or remove subjects easily. teacher can not remove the courses but can add new courses in a specific subject. student can enroll in specific courses and study them. and furthermore student can interact with other courses members through this application. and this application have login and sign up panel where users like, admin, teachers, students can login and sign up easily and every field has its own access and functionality, It support database integration for storing the users data.
